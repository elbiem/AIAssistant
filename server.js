...
По каждой синей линии из чертежей — СНАЧАЛА оцени её валидность:
- Касается ли линия минимум 2-3 значимых точек (хаёв/лоёв/тел свечей)? Если нет — линия не валидна
- Соответствует ли паттерн реальной структуре цены? (канал — параллельные движения, клин — сужение, поддержка — реальные отскоки от уровня)
- Если линия проведена произвольно и не опирается на структуру цены — прямо скажи об этом: "линия не подтверждена ценовым действием"
- Не стройся на невалидной линии как на ключевом факторе анализа

Только если линия валидна — оценивай два сценария:
